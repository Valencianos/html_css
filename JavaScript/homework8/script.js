...
document.addEventListener('click', (e) => {
    if (e.target.className === 'super_element') {
        console.log(`Класс 'super_element' присутствует в элементе ${e.target.nodeName.toLowerCase()}`);
    } else {
        console.log(`Класс 'super_element' отсутствует в элементе ${e.target.nodeName.toLowerCase()}`);
    }
})
...
// При всплытии тег ul идет раньше document

// 7. С помощью JS необходимо изменить цвет заднего фона каждого второго тега li.

const liEl = document.querySelectorAll('li:nth-child(2n)');
